...
<head>
    ...
    <link href="/assets/templates/js/fancybox/jquery.fancybox.css" rel="stylesheet">
    <link href="/assets/templates/js/fancybox/jquery.fancybox-buttons.css" rel="stylesheet">
    <!--<link href="/assets/templates/js/fancybox/jquery.fancybox-media.css" rel="stylesheet">-->
    <link href="/assets/templates/css/styles.css" rel="stylesheet">

    <style>
        .rutube {
            background: url("/assets/templates/img/rutube_sm.png");
...
return array (
    ...
    'resource' =>
        array (
            ...
            'cacheable' => 1,
            'createdby' => 1,
            'createdon' => 1544530748,
            'editedby' => 1,
            'editedon' => 1544532204,
            'deleted' => 0,
            'deletedon' => 0,
            'deletedby' => 0,
            'publishedon' => 1544532180,
            'publishedby' => 1,
            'menutitle' => '',
            'donthit' => 0,
            'privateweb' => 0,
            ...
            'resourcealbum' =>
                array (
                    0 => 'resourcealbum',
                    1 => '[{"MIGX_id":"1","image":"afisha1.png","deleted":"0","published":"1","published_ro":"{\\"name\\":\\"publish\\",\\"use_as_fallback\\":\\"\\",\\"value\\":1,\\"clickaction\\":\\"\\",\\"handler\\":\\"\\",\\"image\\":\\"assets\\\\/components\\\\/migx\\\\/style\\\\/images\\\\/cb_ticked.png\\",\\"idx\\":0,\\"_renderer\\":\\"this.renderSwitchStatusOptions\\",\\"selectorconfig\\":\\"\\"}"}]',
                    2 => 'default',
                    3 => NULL,
                    4 => 'migx',
                ),
...
<html lang="en">
<head>
    <title>28 марта «Шаг навстречу!»</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    ...
    <![endif]-->
',
            '[[$FANCYBOX_CSS]]' => '<link href="/assets/templates/js/fancybox/jquery.fancybox.css" rel="stylesheet">
<link href="/assets/templates/js/fancybox/jquery.fancybox-buttons.css" rel="stylesheet">
<!--<link href="/assets/templates/js/fancybox/jquery.fancybox-media.css" rel="stylesheet">-->',
            '[[pdoMenu?
&level=`2`
...
&tplParentRow=`@INLINE  <li[[+classes]] dropdown>
       ...
       [[+menutitle]]<span class="caret"></span></a>
       [[+wrapper]]
       </li>`
]]' => '<ul class="nav navbar-nav" id="menu"><li class="first"><a href="/" >Главная</a></li><li class="active"><a href="novosti/" >Новости</a></li><li dropdown>
       <a class="dropdown-toggle" data-hover="dropdown" data-delay="100" data-close-others="false" href="about-us/" >
       Об организации<span class="caret"></span></a>
       <ul class="dropdown-menu">
       <li class="first"><a href="about-us/smi-o-nas/" >СМИ о нас</a></li>
       <li><a href="about-us/popechitelskij-sovet/" >Попечительский совет</a></li>
       <li><a href="about-us/blagodarnosti/" >Благодарности</a></li>
       <li><a href="about-us/uchreditelnyie-dokumentyi/" >Учредительные документы</a></li>
       <li><a href="about-us/otcheti/" >Отчёты</a></li>
       <li class="last"><a href="about-us/command/" >Команда</a></li>
       </ul>
       </li><li dropdown>
       <a class="dropdown-toggle" data-hover="dropdown" data-delay="100" data-close-others="false" href="video/" >
       Видео<span class="caret"></span></a>
       <ul class="dropdown-menu"><li class="first"><a href="video/festival-shag-navstrechu/" >Фестиваль "Шаг навстречу!"</a></li></ul>
       </li><li dropdown>
       <a class="dropdown-toggle" data-hover="dropdown" data-delay="100" data-close-others="false" href="foto/" >
       Фото<span class="caret"></span></a>
       <ul class="dropdown-menu">     <li class="first"><a href="foto/photoalbumXIV.html" >XIV фестиваль. 21 мая - 28 июня 2020 г. международный творческий фестиваль «Шаг навстречу!»</a></li>
       <li><a href="foto/photoalbum1.html" >XI фестиваль. 21 мая - 1 июня 2018 г. Выставка художественных работ в фойе Концертного зала Мариинского театра</a></li><li><a href="foto/photoalbum2.html" >XI фестиваль. 26 мая 2018 г. Мастер-классы фортепианного мастерства.</a></li><li><a href="foto/photoalbum3.html" >XI фестиваль. 26 мая 2018 г. Репетиция Руслана Сака и Олега Аккуратова в Концертном зале Мариинского театра</a></li><li><a href="foto/photoalbum4.html" >XI фестиваль. 27 мая 2018 г. Торжественное открытие фестиваля на Площади Искусств.</a></li><li><a href="foto/xi-festival.-27-maya-2018-g.-konczert-otkryitie-festivalya-v-konczertnom-zale-mariinskogo-teatra.html" >XI фестиваль. 27 мая 2018 г. Концерт - открытие фестиваля - в Концертном зале Мариинского театра. Альбом I.</a></li><li><a href="foto/xi-festival.-27-maya-2018-g.-konczert-otkryitie-festivalya-v-konczertnom-zale-mariinskogo-teatra.-albom-ii.html" >XI фестиваль. 27 мая 2018 г. Концерт - открытие фестиваля - в Концертном зале Мариинского театра. Альбом II.</a></li><li class="last"><a href="foto/photoalbum5.html" >21 октября Концерт выпускников Санкт-Петербургской Консерватории им. Римского-Корсакова</a></li></ul>
       </li><li dropdown>
       <a class="dropdown-toggle" data-hover="dropdown" data-delay="100" data-close-others="false" href="proektyi/festival/" >
       Проекты<span class="caret"></span></a>
       <ul class="dropdown-menu"><li class="first"><a href="proektyi/festival/" >Фестиваль</a></li><li><a href="proektyi/prosvetitelskie/" >Просветительские</a></li><li><a href="proektyi/coczialno-reabilitaczionnyie-proektyi.html" >Cоциально-реабилитационные</a></li><li class="last"><a href="proektyi/soczialnyie-proektyi-dlya-lyudej-pozhilogo-vozrasta/" >Для пожилых людей</a></li>  <li class="last"><a href="proektyi/mozhem_vse/"> Проект «Вместе можем всё!»</a></li></ul>
       </li><li><a href="partneryi.html" >Партнеры</a></li><li class="last"><a href="kontaktyi.html" >Контакты</a></li></ul>',
            '[[$HEADER]]' => '<header>
<nav class="navbar navbar-default navbar-fixed-top">
<div class="container-fluid headerwrap">
<div class="container">
<a class="navbar-brand hidden-xs" href="/"><span class="hidden-sm">АНО "Международный творческий фестиваль </span>"Шаг навстречу!"</a>
<div class="grand hidden-xs"><a href="/"><img src="/assets/templates/img/logo_grand.png"></a></div>
<div class="contacts-top hidden-xs">

<div class="top_social_wrap">
<a class="vk" href="https://vk.com/spbfeststep"></a>
<a class="fb" href="https://www.facebook.com/АНО-Международный-творческий-фестиваль-Шаг-навстречу-322695084603046/"></a>
<a class="tw" href="https://twitter.com/feststepspb"></a>
<a class="yt" href="https://www.youtube.com/user/FestStep2013/playlists"></a>
<a class="inst" href="/"></a>
</div>
<div class="clear"></div>

<div class="top_address_wrap">
<div class="address_top">Санкт-Петербург, Невский пр. 127, лит. Е</div>
<div class="phones_top">8 (812) 717-11-92, 8 (812) 242-76-73</div>
</div>
</div>
...
<a class="navbar-brand visible-xs" href="/">Шаг навстречу!</a>
</div>
...
<ul class="nav navbar-nav" id="menu"><li class="first"><a href="/" >Главная</a></li><li class="active"><a href="novosti/" >Новости</a></li><li dropdown>
       ...
       Проекты<span class="caret"></span></a>
       <ul class="dropdown-menu"><li class="first"><a href="proektyi/festival/" >Фестиваль</a></li><li><a href="proektyi/prosvetitelskie/" >Просветительские</a></li><li><a href="proektyi/coczialno-reabilitaczionnyie-proektyi.html" >Cоциально-реабилитационные</a></li><li class="last"><a href="proektyi/soczialnyie-proektyi-dlya-lyudej-pozhilogo-vozrasta/" >Для пожилых людей</a></li>  <li class="last"><a href="proektyi/mozhem_vse/"> Проект «Вместе можем всё!»</a></li></ul>
       </li><li><a href="partneryi.html" >Партнеры</a></li><li class="last"><a href="kontaktyi.html" >Контакты</a></li></ul></div>

</div>
</div>
</nav>
</header>',
            '[[pdoCrumbs? &showHome=`1`]]' => '<ul class="breadcrumb"><li><a href="/">Главная</a></li>
<li><a href="novosti/">Новости и мероприятия</a></li>
<li class="active">6 марта «Шаг навстречу!»</li></ul>',
            '[[$BREADCRUMBS]]' => '<div class="container-fluid breadcrumbwrap">
<div class="container no-gutter">
...
<li class="active">6 марта «Шаг навстречу!»</li></ul>
  ...
  &limit=`1`
  &tpl=`@CODE:<img class="img-responsive" src="[[+image:getThumb=`.768`]]" />`
]]' => '<img class="img-responsive" src="assets/resourcefiles/674/.768/afisha1.png" />',
            '[[getImageList?
  &docid=`674`
  &tvname=`resourcealbum`
  &limit=`0`
  ...
  &processTv=`1`]`
]]' => '<div class="col-xs-4 foto-prev no-gutter">
<a href="assets/resourcefiles/674/.768/afisha1.png" 674/.768/afisha1.pngclass="fancybox" rel="fancybox" title="[[+title]]"><img src="assets/resourcefiles/674/.360/afisha1.png"  class="img-responsive"/></a>
</div>',
            '[[$CONTENT-NEWS]]' => '<section>
 <img class="img-responsive" src="assets/resourcefiles/674/.768/afisha1.png" />
</section>
<h1>6 марта «Шаг навстречу!»</h1>
<span class="date">12.07.2018</span>
<section>
  <p>
    <p>Участие молодежи с ограниченными возможностями здоровья на Всемирном фестивале молодёжи в Сочи</p>
  </p>
</section>
<div class="gallerybox">
<div class="col-xs-4 foto-prev no-gutter">
<a href="assets/resourcefiles/674/.768/afisha1.png" class="fancybox" rel="fancybox" title="[[+title]]"><img src="assets/resourcefiles/674/.360/afisha1.png"  class="img-responsive"/></a>
</div>
</div>',
            '[[$twitter]]' => '<div class="side_wrap">
<div class="side_block_head twitter">
  <h2>Наш twitter</h2>
</div>
<div class="side_block_wrap">
 <a class="twitter-timeline" href="https://twitter.com/feststepspb" data-widget-id="510028820041068544">Твиты пользователя @feststepspb</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?\'http\':\'https\';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
</div>
<div class="side_block_bottom twitter">
  <a href="https://twitter.com/feststepspb" target="_blank">Подписаться на @feststepspb</a>
</div>
</div>


',
            '[[youtube? &url=`https://www.youtube.com/watch?v=sdzM0h4dx4I`]]' => '<iframe width="640" height="352" src="https://www.youtube.com/embed/sdzM0h4dx4I" frameborder="0" allowfullscreen="1" rel="0"></iframe>',
            '[[youtube? &url=`https://www.youtube.com/watch?v=2y21jPPGDzs`]]' => '<iframe width="640" height="352" src="https://www.youtube.com/embed/2y21jPPGDzs" frameborder="0" allowfullscreen="1" rel="0"></iframe>',
            '[[youtube? &url=`https://www.youtube.com/watch?v=gyhqeQa2qn0`]]' => '<iframe width="640" height="352" src="https://www.youtube.com/embed/gyhqeQa2qn0" frameborder="0" allowfullscreen="1" rel="0"></iframe>',
            '[[getImageList?
  &docid = `28`
  &tvname=`videoalbum`
  &tpl=`youtubeTplside`
...
<iframe width="640" height="352" src="https://www.youtube.com/embed/sdzM0h4dx4I" frameborder="0" allowfullscreen="1" rel="0"></iframe>
</div>
[[+youtube_date]]
<div class="side_block_txt">
Десятый фестиваль "Шаг навстречу!" в Михайловском саду
</div>
</div>
<div class="side_block_wrap">
<div class="video-container">
<iframe width="640" height="352" src="https://www.youtube.com/embed/2y21jPPGDzs" frameborder="0" allowfullscreen="1" rel="0"></iframe>
</div>
[[+youtube_date]]
<div class="side_block_txt">
Десятый Фестиваль "Шаг навстречу!" Елена Мартиросова и Илья Селиванов
</div>
</div>
<div class="side_block_wrap">
<div class="video-container">
<iframe width="640" height="352" src="https://www.youtube.com/embed/gyhqeQa2qn0" frameborder="0" allowfullscreen="1" rel="0"></iframe>
</div>
[[+youtube_date]]
<div class="side_block_txt">
Десятый Фестиваль "Шаг навстречу!", БЗФ, Олег Аккуратов
</div>
</div>
',
            '[[$youtube]]' => '<div class="side_wrap">
<div class="side_block_head youtube">
  <h2>Мы на youtube</h2>
</div>
 <div class="side_block_wrap">
<div class="video-container">
...
<div class="side_block_bottom youtube">
  <a href="video-old.html">Посмотреть все записи</a>
</div>
</div>
',
            '[[$FOOTER]]' => '<div class="container-fluid footerwrap">
<div class="container">
<div class="footer_txt">
АНО Международный творческий фестиваль "Шаг навстречу!" © 2008 - 2025 Политика конфиденциальности.
Название, логотип, фирменная символика Международного творческого Фестиваля детей с ограниченными возможностями «Шаг навстречу!» официально зарегистрированные знаки в WIPO и, равно как и сам Фестиваль, являются интеллектуальной собственностью АНО «Международный творческий Фестиваль детей с ограниченными возможностями «Шаг навстречу!» и охраняются Законом «Об авторских правах и интеллектуальной собственности”.<div class="center">
<a class="button_link" href="http://zayavki.feststep.com/user/signup">Заявки на 2025 год</a>
</div>
<div>
<!-- Yandex.Metrika informer -->
<a href="https://metrika.yandex.ru/stat/?id=57496599&amp;from=informer"
target="_blank" rel="nofollow"><img src="https://informer.yandex.ru/informer/57496599/3_1_FFFFFFFF_EFEFEFFF_0_visits"
style="width:88px; height:31px; border:0;" alt="Яндекс.Метрика" title="Яндекс.Метрика: данные за сегодня (просмотры, визиты и уникальные посетители)" class="ym-advanced-informer" data-cid="57496599" data-lang="ru" /></a>
<!-- /Yandex.Metrika informer -->
...
<noscript><div><img src="https://mc.yandex.ru/watch/57496599" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</div>
</div>
</div>
<!-- Render time: [^t^] -->',
            '[[$JS]]' => '<script src="http://code.jquery.com/jquery-3.1.1.min.js"></script>
...
',
            '[[$JS_FANCYBOX]]' => '<script src="/assets/templates/js/fancybox/jquery.fancybox.js"></script>
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <link href="[[++templates_path]]css/bootstrap.css" rel="stylesheet">
    <link rel="shortcut icon" href="favicon.ico">
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn\'t work if you view the page via file:// -->
    <!--[if lt IE 9]>
                                        ...
                                        array (
                                            'basePath' =>
                                                array (
                                                    ...
                                                    'value' => '[[!migxResourceMediaPath? &pathTpl=`assets/resourcefiles/{id}/` &createFolder=`1`]]',
                                                    'lexicon' => 'core:source',
                                                ),
                                            'baseUrl' =>
                                                array (
                        ...
                        array (
                            'fields' =>
                                array (
                                    ...
                                    'category' => 0,
                                    'cache_type' => 0,
                                    'snippet' => '<link href="[[++templates_path]]js/fancybox/jquery.fancybox.css" rel="stylesheet">
<link href="[[++templates_path]]js/fancybox/jquery.fancybox-buttons.css" rel="stylesheet">
<!--<link href="[[++templates_path]]js/fancybox/jquery.fancybox-media.css" rel="stylesheet">-->',
                                    'locked' => false,
                                    'properties' =>
                                        array (
                                        ),
                                    'static' => false,
                                    'static_file' => '',
                                    'content' => '<link href="[[++templates_path]]js/fancybox/jquery.fancybox.css" rel="stylesheet">
<link href="[[++templates_path]]js/fancybox/jquery.fancybox-buttons.css" rel="stylesheet">
<!--<link href="[[++templates_path]]js/fancybox/jquery.fancybox-media.css" rel="stylesheet">-->',
                                ),
                            'policies' =>
                        ...
                        array (
                            'fields' =>
                                array (
                                    ...
                                    'category' => 0,
                                    'cache_type' => 0,
                                    'snippet' => '<div class="container-fluid breadcrumbwrap">
<div class="container no-gutter">
[[pdoCrumbs? &showHome=`1`]]
                                    ...
                                    'static' => false,
                                    'static_file' => '',
                                    'content' => '<div class="container-fluid breadcrumbwrap">
<div class="container no-gutter">
[[pdoCrumbs? &showHome=`1`]]
</div>
</div>',
...
<h1>[[*pagetitle]]</h1>
<span class="date">[[*pubdate:strtotime:date=`%d.%m.%Y`]]</span>
<section>
  <p>
    [[*content]]
  </p>
...
<div class="side_block_bottom youtube">
  <a href="[[~28]]">Посмотреть все записи</a>
</div>
</div>
',
                                    'locked' => false,
                        ...
                        array (
                            'fields' =>
                                array (
                                    ...
                                    'category' => 0,
                                    'cache_type' => 0,
                                    'snippet' => '<div class="container-fluid footerwrap">
<div class="container">
<div class="footer_txt">
АНО Международный творческий фестиваль "Шаг навстречу!" © 2008 - 2025 Политика конфиденциальности.
Название, логотип, фирменная символика Международного творческого Фестиваля детей с ограниченными возможностями «Шаг навстречу!» официально зарегистрированные знаки в WIPO и, равно как и сам Фестиваль, являются интеллектуальной собственностью АНО «Международный творческий Фестиваль детей с ограниченными возможностями «Шаг навстречу!» и охраняются Законом «Об авторских правах и интеллектуальной собственности”.<div class="center">
...
<!-- Render time: [^t^] -->',
                                    ...
                                    'static' => false,
                                    'static_file' => '',
                                    'content' => '<div class="container-fluid footerwrap">
<div class="container">
<div class="footer_txt">
АНО Международный творческий фестиваль "Шаг навстречу!" © 2008 - 2025 Политика конфиденциальности.
Название, логотип, фирменная символика Международного творческого Фестиваля детей с ограниченными возможностями «Шаг навстречу!» официально зарегистрированные знаки в WIPO и, равно как и сам Фестиваль, являются интеллектуальной собственностью АНО «Международный творческий Фестиваль детей с ограниченными возможностями «Шаг навстречу!» и охраняются Законом «Об авторских правах и интеллектуальной собственности”.<div class="center">
                        ...
                        array (
                            'fields' =>
                                array (
                                    ...
                                    'category' => 0,
                                    'cache_type' => 0,
                                    'snippet' => '<script src="http://code.jquery.com/jquery-3.1.1.min.js"></script>
<script src="[[++templates_path]]js/bootstrap.min.js"></script>
<script src="[[++templates_path]]js/bootstrap.hover.menu.js"></script>
...
',
                                    ...
                                    'static' => false,
                                    'static_file' => '',
                                    'content' => '<script src="http://code.jquery.com/jquery-3.1.1.min.js"></script>
<script src="[[++templates_path]]js/bootstrap.min.js"></script>
<script src="[[++templates_path]]js/bootstrap.hover.menu.js"></script>
                        ...
                        array (
                            'fields' =>
                                array (
                                    ...
                                    'category' => 0,
                                    'cache_type' => 0,
                                    'snippet' => '<script src="[[++templates_path]]js/fancybox/jquery.fancybox.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery.touchswipe/1.6.4/jquery.touchSwipe.js"></script>
<script src="[[++templates_path]]js/fancybox/jquery.fancybox-buttons.js"></script>
<script src="[[++templates_path]]js/fancybox/jquery.fancybox-media.js"></script>
<script src="[[++templates_path]]js/fancybox/jquery.fancybox-thumbs.js"></script>
<script src="[[++templates_path]]js/fancybox/jquery.mousewheel.pack.js"></script>
<script type="text/javascript">
$(document).ready(function() {
$(\'.fancybox\').fancybox({
        width: "100%",
        ...
        beforeShow : function() {
            this.title = (this.title ? \'\' + this.title + \'\' : \'\') + \' <span class="num">\' + (this.index + 1) + \' of \' + this.group.length + \' </span>\';
                                    ...
                                    'static' => false,
                                    'static_file' => '',
                                    'content' => '<script src="[[++templates_path]]js/fancybox/jquery.fancybox.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery.touchswipe/1.6.4/jquery.touchSwipe.js"></script>
<script src="[[++templates_path]]js/fancybox/jquery.fancybox-buttons.js"></script>
<script src="[[++templates_path]]js/fancybox/jquery.fancybox-media.js"></script>
<script src="[[++templates_path]]js/fancybox/jquery.fancybox-thumbs.js"></script>
                        ...
                        array (
                            'fields' =>
                                array (
                                    ...
                                    'category' => 0,
                                    'cache_type' => 0,
                                    'snippet' => 'if(empty($options)){
    return $input;
}
$path=dirname($input);
$fn=basename($input);
return str_replace($path, $path.\'/\'.$options, $input);',
                                    'locked' => false,
                                    'properties' =>
                                        array (
                                        ),
                        ...
                        array (
                            'fields' =>
                                array (
                                    ...
                                    'category' => 0,
                                    'cache_type' => 0,
                                    'snippet' => '$url = $modx->getOption(\'url\', $scriptProperties, \'\');
if ($url) {
...
$output=\'<iframe width="640" height="352" src="https://www.youtube.com/embed/\'.$id[1].\'" frameborder="0" allowfullscreen="1" rel="0"></iframe>\';
return $output;
}',
                                    'locked' => false,
                                    'properties' =>
                                    ...
                                    'static' => false,
                                    'static_file' => '',
                                    'content' => '$url = $modx->getOption(\'url\', $scriptProperties, \'\');
if ($url) {
if ( preg_match( "/(http|https):\\/\\/(www.youtube|youtube|youtu)\\.(be|com)\\/([^<\\s]*)/", $url, $match ) ) {
  if ( preg_match( \'/youtube\\.com\\/watch\\?v=([^\\&\\?\\/]+)/\', $url, $id ) ) {
      $values = $id[1];
